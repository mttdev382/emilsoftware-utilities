...
export abstract class AccessiControllerBase {
  ...
  public abstract verifyEmail(req: Request<{ token: string }>, res: Response);
  public abstract requestPasswordReset(req: Request, res: Response);
  public abstract resetPassword(req: Request<{ token: string }, {}, { newPassword: string }>, res: Response);
}
